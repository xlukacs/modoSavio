      ...
      <div class="content-box">
        ...
        <div class="info-section">
          <ul class="info-list">
            <li>
              <div class="info-item">
                <strong>Osvedčenia a certifikáty</strong>
                <div class="details certificate-container">
                  <q-img src="pic/MENDELU_certificate.png" class="certificate-img" fit="contain"/>
                </div>
              </div>
            </li>
            <li>
